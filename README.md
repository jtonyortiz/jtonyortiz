### Hello There and WELCOME to James's GitHub Page! 👋

## Introduction:
Hello everyone, my name is James, I am currently an undergrad Computer Science student at Florida State University (FSU). I love to learn about new technolgies and recent developments in software as well as improving on important development concepts. A lot of my software development skills hover around programming languages such as C/C++ for Systems Development, C# and the .Net Framework for Web Applications, and finally, Kotlin and Java for Mobile Development. Please feel free to look at my repos to get a glimpse of the projects i'vee worked on my own and also in academia.
